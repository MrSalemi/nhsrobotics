...
TESTS = [
    ...
    ("Move: accelerate forwards matches the profile",
     move.test_accelerate_forwards_matches_the_profile),
    ...
    ("Move: the go light holds through the run",
     move.test_the_go_light_holds_through_the_run),
    ("Move: Cancel during the countdown aborts",
     move.test_cancel_during_the_countdown_aborts),
    ("Move: a run lasts 6.5 seconds",
     move.test_a_run_lasts_six_and_a_half_seconds),
    ...
    ("Move: each second gets its own colour",
     move.test_each_second_gets_its_own_colour),
    ("Move: the marks are distinct and none is white",
     move.test_the_marks_are_distinct_and_none_is_white),
    ("Move: the last mark holds then goes out",
     move.test_the_last_mark_holds_then_goes_out),
    ("Move: the marks do not disturb the measurement",
     move.test_the_marks_do_not_disturb_the_measurement),
